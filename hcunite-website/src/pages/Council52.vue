...
const councillors = {
    ...
    "EcaCo": {
        ...
        "BRAYDEN TEE QI YUAN (CHI QIYUAN)": {
            "position": "",
    ...
    "PubCo": {
        ...
        "HEBE TANG QIAO EN": {
            "position": "",
            "description": "hey! im hebe 📢😛 and i have a dream that one day i will have get 8 hours of sleep per day every day 🥱😴🛏️💤"
        },
        "HUANG XI": {
            "position": "",
    ...
    "SnR": {
        ...
        "GOH KAI TONG": {
            "position": "",
            "description": "HEYO i'm kai tong!!💃 ❤️💛💚💙did i just witness super women fly past the barn....?! 🦸‍♀️👀"
        },
        "CHUA ZHI EN": {
            "position": "",
    ...
    "SecCo": {
        ...
        "TAN KING HEI ISAAC (CHEN JINGXI)": {
            "position": "",
...
<!-- hero section -->
    ...
    <section ref="nse" class="pb-12 px-3">
        <div class=" aspect-3/2 rounded-xl overflow-hidden relative">
            <img src="/images/52nd/52nd_NSE.jpg" alt="background" class="w-full h-full z-0 object-cover brightness-90">
    ...
    <section ref="ecaco" class="pb-12 px-3">
        <div class="aspect-3/2 rounded-xl overflow-hidden relative">
            <img src="/images/52nd/52nd_EcaCo.jpg" alt="background" class="w-full h-full z-0 object-cover">
    ...
    <section ref="pubco" class="pb-12 px-3 ">
        <div class=" aspect-3/2 rounded-xl overflow-hidden relative">
            <img src="/images/52nd/52nd_PubCo.jpg" alt="background" class="w-full h-full z-0 object-cover">
    ...
    <section ref="secco" class="pb-12 px-3 ">
        <div class=" aspect-3/2 rounded-xl overflow-hidden relative">
            <img src="/images/52nd/52nd_SecCo.jpg" alt="background" class="w-full h-full z-0 object-cover">
    ...
    <section ref="snr" class="pb-12 px-3 ">
        <div class=" aspect-3/2 rounded-xl overflow-hidden relative">
            <img src="/images/52nd/52nd_SnR.jpg" alt="background" class="w-full h-full z-0 object-cover">
            <h1 class="w-full absolute top-[50%] left-[52%] transform -translate-x-1/2 -translate-y-1/2 z-20 text-center font-inter font-black text-white tracking-[0.5em] text-2xl/10 sm:text-5xl/18 lg:tracking-[0.3em] lg:text-8xl/30">
                THE SOCIAL<br>
                AND RELATIONS<br>
                COMMITTEE<br>
    ...
    <section ref="welco" class="pb-12 px-3 ">
        <div class=" aspect-3/2 rounded-xl overflow-hidden relative">
            <img src="/images/52nd/52nd_WelCo.jpg" alt="background" class="w-full h-full z-0 object-cover">
